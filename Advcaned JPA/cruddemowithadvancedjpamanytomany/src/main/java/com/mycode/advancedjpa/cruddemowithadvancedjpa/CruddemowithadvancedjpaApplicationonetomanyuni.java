...
import com.mycode.advancedjpa.cruddemowithadvancedjpa.entity.Review;
import com.mycode.advancedjpa.cruddemowithadvancedjpa.entity.Student;

@SpringBootApplication
public class CruddemowithadvancedjpaApplicationonetomanyuni {

	public static void main(String[] args) {
		SpringApplication.run(CruddemowithadvancedjpaApplicationonetomanyuni.class, args);
	}
...
//			deleteCourse(appDAO);
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		tempStudent.addCourse(new Course("This is new course that is being added..."));
	...
	private void findCourseAndStudentsByCourseId(AppDAO appDAO) {
		...
		System.out.println("Finding Course and Student by CourseId: " + theId);
		Course theCourse = appDAO.findCourseAndStudentsByCourseId(theId);
		
		System.out.println("Associated Course: "+ theCourse);
		System.out.println("Associated Students with course: " + theCourse.getStudents());
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		//create course
		Course tempCourse = new Course("Learn Python in 10 days");
		
		//add Students
		tempCourse.addStudent(new Student("Mukul", "Kolte", "mukul@gmail.com"));
		tempCourse.addStudent(new Student("Chirag", "Kolte", "chirag@gmail.com"));
		tempCourse.addStudent(new Student("Pranil", "Shete", "pranil@gmail.com"));
	...
	private void retrieveCourseAndReviews(AppDAO appDAO) {
		...
		int theId = 10;
		System.out.println("Finding Courses and Reviews for id: " + theId);
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		...
		theCourse.addReview(new Review("Could have been better..."));
		theCourse.addReview(new Review("Helped me beating my pprevious score."));
